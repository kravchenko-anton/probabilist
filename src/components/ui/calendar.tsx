  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "rounded-(--cell-radius) text-foreground ring-1 ring-primary ring-inset not-data-[selected=true]:bg-primary/25 data-[selected=true]:rounded-none",
