...
const htmlPath = path.join(__dirname, "road-journey-anim.html")
const framesDir = path.join(__dirname, "road-journey-frames")
const finalMp4 = path.join(__dirname, "road-journey-success.mp4")
const FPS = 60
...
console.log(`Capturing ${totalFrames} road frames @ ${FPS}fps…`)
